...
lable=Label(root,text="company name/logo ",font=("Arial",14,"bold"),bg="white",fg="black").place(x=1220,y=60)

# turn on less secure key from your google account
#I recommend to use a temp mail address for this
...
def send():
    ...
    try:
        ...
        server.starttls()
        server.login('Enter your gmail address', "Enter your gmail password")
        otp = random.randint(1000, 9999)
        otp = str(otp)
        msg = ("You have succesfully registered on QUIZER! \n Use the OTP given below to verify your email ID. " + otp)
        server.sendmail("Enter your gmail address", userentry.get(), msg)
